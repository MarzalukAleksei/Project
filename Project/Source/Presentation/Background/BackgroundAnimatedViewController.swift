...
//    
//    private let backgroundInteractor: IBackgroundInteractor = BackgroundInteractor(kanaRepository: KanaRepository(store: KanaMapper(csvMapper: CSVMapper()), mapper: Stores.shared.kanaStore))
//    
